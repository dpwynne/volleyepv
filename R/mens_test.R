...
epv_ratio <- aggregate(epv_ratio ~ player_name*position*team*conference, subset(mens_test, skill == "Attack"), mean)
colnames(epv_ratio) <- c("player_name", "position", "team", "conference", "epv_ratio")
